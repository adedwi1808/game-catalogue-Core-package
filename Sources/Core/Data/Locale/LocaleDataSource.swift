...
public final class LocaleDataSource: NSObject {
    ...
    @MainActor
    public static let sharedInstance: (RealmManagerProtocol?) -> LocaleDataSource = { realmDatabase in
...
extension LocaleDataSource: LocaleDataSourceProtocol {
    public func saveToFavorite(game: GameEntity) -> AnyPublisher<Void, any Error> {
    ...
    public func removeFromFavorite(game: GameEntity) -> AnyPublisher<Void, any Error> {
        return Future { completion in
            Task {
                guard let realm = self.realm else {
                    completion(.failure(DatabaseError.invalidInstance))
    ...
    public func getLocaleGames() -> AnyPublisher<[GameEntity], Error> {
